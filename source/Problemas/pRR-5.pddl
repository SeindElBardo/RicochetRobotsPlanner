(define (problem pRR-5)
	...
	(:init
		...
		; Barras Mágicas
		(hasBarrier A02)
		(barraMagica A02 verde  slash)
		(hasBarrier A03)
		(barraMagica A03 verde  backslash)
		(hasBarrier C03)
		(barraMagica C03 verde  slash)
		(hasBarrier D02)
		(barraMagica D02 verde  backslash)
		; Casillas objetivo
		(casillaObjetivo D04 rojo)
		(casillaObjetivo D01 amarillo)
		; Casillas Adyacentes
		...
		(adyacente B01 B01 right)	; Pared B01 - B02
		(adyacente B01 C01 down)
		(adyacente B02 B02 left)	; Pared B02 - B01
