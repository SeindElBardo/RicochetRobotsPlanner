(define (problem pRR-7_5)
	...
	(:init
		...
		; Barras Mágicas
		(hasBarrier B03)
		(barraMagica B03 verde  slash)
		; Casillas objetivo
		(casillaObjetivo D03 rojo)
		; Casillas Adyacentes
		...
		(adyacente A03 A03 down)	; Pared A03 - B03
		...
		(adyacente B03 B03 up)		; Pared B03 - A03
		...
		(adyacente D02 D02 right)	; Pared D02 - D02
		(adyacente D02 D02 down)	; Pared D02 DownFin
		(adyacente D03 D03 left)	; Pared D03 - D02
		(adyacente D03 C03 up)
		(adyacente D03 D03 right)	; Pared D03 - D03
		(adyacente D03 D03 down)	; Pared D03 DownFin
		(adyacente D04 D04 left)	; Pared D04 - D03
